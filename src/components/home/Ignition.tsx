...
const Ignition = ({ hasWorks = true }: { hasWorks?: boolean }) => {
  ...
  return (
    <section
      id="home-intro"
      className="relative flex min-h-[100svh] flex-col items-center justify-center px-5 pb-28 pt-32 text-white md:px-12"
    >
      ...
      >
        <span className="copy-th text-xs tracking-wider">
