...
function FacebookIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 1.09.044 1.613.115L16.948.2v3.385c-.417-.045-.95-.067-1.573-.067-1.467 0-2.033.556-2.033 2v1.526h3.39l-.477 3.667H13.34v8.075C19.395 17.668 24 13.347 24 8 24 3.582 20.418 0 16 0S0 3.582 0 8c0 3.89 2.945 7.095 6.737 7.678l-.008-.002 2.372 8.015Z" />
    </svg>
  )
}
